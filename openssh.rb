class Openssh < Formula
  ...
  if build.with? "gsskex"
    patch do
      url "https://raw.githubusercontent.com/poffe/homebrew-dupes/openssh-gsskex/patches/openssh/gssapi.patch"
      sha256 "caccfdac6b610c034a8867fb8bc79df242bff085b8cf4465473ffc4e7f38901e"
    end
  end
  ...
  if OS.mac?
    ...
    patch do
      ...
      url "https://raw.githubusercontent.com/Homebrew/formula-patches/master/openssh/patch-sshd.c-apple-sandbox-named-external.diff"
